...
public class InTheatresFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_in_theatres, container, false);

        final RecyclerView recyclerView = (RecyclerView) view.findViewById(R.id.movies_intheatres);
        recyclerView.setLayoutManager(new GridLayoutManager(getActivity(),2));

        ApiInterface apiService = ApiClient.getClient().create(ApiInterface.class);

        Call<MovieResponse> call = apiService.getNowPlayingMovies(MainActivity.API_KEY,"ID");
